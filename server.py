...
def send_msg(conn, obj):
    """Envia objeto Python com pickle + cabeçalho (tamanho em 4 bytes)."""
...
def recv_msg(conn):
    """Recebe objeto Python usando cabeçalho fixo."""
    header = b''
    while len(header) < 4:
...
def naive_matmul(A, B):
    """
    Multiplicação de matrizes usando 3 laços for.
    Mesma lógica usada no cliente.
    """
